...
*Buyback: 0xC2c869dAc0d188A55a39985f1F788bBECB219419
*Token1: 0xa956b15259577cdFc671a813BFd66beDD3f5DF97

*CMC_Dividend: 0xe0272187e172A539469Ae06f090189B8Cd15738e

Evergrow 0xc001bbe2b87079294c63ece98bdd0a88d761434e      

Metapets 0x24ce3d571fbcfd9d81dc0e1a560504636a4d046d

Token1 0xa956b15259577cdFc671a813BFd66beDD3f5DF97 (1 cent)

Token2  0xc830D51596B0390a68D8cA7FA786AeA9Fbe815a3

Token3 0x9d307D47E5D93252ea2028dDE7dDf753820891B0

*/

/*TODO:
*Change the hardcoded numbers
*Change the buyback addresses according to BSC mainnet
*/
...
contract Lottery is LotteryOwnable, Initializable {
    ...
    function multiBuyWithBNB(uint8[4][] memory _numbers) payable external {
        ...
        emit MultiBuy(msg.sender, _price);
    }
